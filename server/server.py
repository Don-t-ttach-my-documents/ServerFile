...
#Update
@app.route("/docs/<doc_name>", methods=['PUT'])
def updateDoc(doc_name):
...
#Delete
@app.route("/docs/<name_doc>", methods=['DELETE'])
def deleteDoc(name_doc):
	try:
...
#Read
@app.route("/docs/<name_doc>", methods=['GET'])
def getDoc(name_doc):
    try:
